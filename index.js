...
var App = /** @class */ (function () {
  function App() {
    ...
    this.renderCurrent = function () {
      ...
      if (!size) size = parseFloat(_this.sizeInput.value);
      if (!size) size = 100;
      _this.render(
    ...
    this.loadVariants = function () {
      ...
      var v = f.variants.forEach(function (v) {
        return _this.addOption(_this.selectVariant, v);
      });
      _this.renderCurrent();
    };
    ...
    this.updateUrl = function () {
      ...
      urlSearchParams.set(
        "input-kerning",
        String(_this.kerningCheckbox.checked),
      );
      urlSearchParams.set(
        "input-separate",
        String(_this.separateCheckbox.checked),
      );
  ...
  App.prototype.callMakerjs = function (
    font,
    text,
    size,
    union,
